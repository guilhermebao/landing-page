import {
  ...
  export default function Example() {
    return (
      <div className="bg-orange-400/10">
      <div className="container mx-auto py-16 md:py-24">
        <h2 className="mb-2 text-center text-3xl font-extrabold text-foreground md:text-4xl">
        Por que a <span className="text-orange-400">MVM Engenharia</span> é a <span className="text-orange-400" >Assessoria Perfeita</span> para se contratar? 
        </h2>
          ...
          {stats.map((item) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                {/* Título */}
                <h3 className="mt-4 text-lg font-medium text-orange-400">
                  {item.name}
                </h3>
